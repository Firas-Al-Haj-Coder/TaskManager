...
function App() {
  ...
  const [tasklist, setTasklist] = useState(JSON.parse(localStorage.getItem("tasklistKey")) || []); // hole eine exisiterende Liste aus einem Localstorage oder erstelle eine neue Liste
